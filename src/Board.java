public class Board {
    ...
    public void tacticalBoard() {
        ...
        System.out.print("    |---|---|---|---|---|---|---|---|---|---|\n");
        System.out.print("  1 | " + tacticalGrid[0][0] + " | " + tacticalGrid[0][1] + " | " + tacticalGrid[0][2] + " | " + tacticalGrid[0][3] + " | " + tacticalGrid[0][4] + " | " + tacticalGrid[0][5] + " | " + tacticalGrid[0][6] + " | " + tacticalGrid[0][7] + " | " + tacticalGrid[0][8] + " | " + tacticalGrid[0][9] + " |\n");
        System.out.print("    |---|---|---|---|---|---|---|---|---|---|\n");
        System.out.print("  2 | " + tacticalGrid[1][0] + " | " + tacticalGrid[1][1] + " | " + tacticalGrid[1][2] + " | " + tacticalGrid[1][3] + " | " + tacticalGrid[1][4] + " | " + tacticalGrid[1][5] + " | " + tacticalGrid[1][6] + " | " + tacticalGrid[1][7] + " | " + tacticalGrid[1][8] + " | " + tacticalGrid[1][9] + " |\n");
        System.out.print("    |---|---|---|---|---|---|---|---|---|---|\n");
        System.out.print("  3 | " + tacticalGrid[2][0] + " | " + tacticalGrid[2][1] + " | " + tacticalGrid[2][2] + " | " + tacticalGrid[2][3] + " | " + tacticalGrid[2][4] + " | " + tacticalGrid[2][5] + " | " + tacticalGrid[2][6] + " | " + tacticalGrid[2][7] + " | " + tacticalGrid[2][8] + " | " + tacticalGrid[2][9] + " |\n");
        System.out.print("    |---|---|---|---|---|---|---|---|---|---|\n");
        System.out.print("  4 | " + tacticalGrid[3][0] + " | " + tacticalGrid[3][1] + " | " + tacticalGrid[3][2] + " | " + tacticalGrid[3][3] + " | " + tacticalGrid[3][4] + " | " + tacticalGrid[3][5] + " | " + tacticalGrid[3][6] + " | " + tacticalGrid[3][7] + " | " + tacticalGrid[3][8] + " | " + tacticalGrid[3][9] + " |\n");
        System.out.print("    |---|---|---|---|---|---|---|---|---|---|\n");
        System.out.print("  5 | " + tacticalGrid[4][0] + " | " + tacticalGrid[4][1] + " | " + tacticalGrid[4][2] + " | " + tacticalGrid[4][3] + " | " + tacticalGrid[4][4] + " | " + tacticalGrid[4][5] + " | " + tacticalGrid[4][6] + " | " + tacticalGrid[4][7] + " | " + tacticalGrid[4][8] + " | " + tacticalGrid[4][9] + " |\n");
        System.out.print("    |---|---|---|---|---|---|---|---|---|---|\n");
        System.out.print("  6 | " + tacticalGrid[5][0] + " | " + tacticalGrid[5][1] + " | " + tacticalGrid[5][2] + " | " + tacticalGrid[5][3] + " | " + tacticalGrid[5][4] + " | " + tacticalGrid[5][5] + " | " + tacticalGrid[5][6] + " | " + tacticalGrid[5][7] + " | " + tacticalGrid[5][8] + " | " + tacticalGrid[5][9] + " |\n");
        System.out.print("    |---|---|---|---|---|---|---|---|---|---|\n");
        System.out.print("  7 | " + tacticalGrid[6][0] + " | " + tacticalGrid[6][1] + " | " + tacticalGrid[6][2] + " | " + tacticalGrid[6][3] + " | " + tacticalGrid[6][4] + " | " + tacticalGrid[6][5] + " | " + tacticalGrid[6][6] + " | " + tacticalGrid[6][7] + " | " + tacticalGrid[6][8] + " | " + tacticalGrid[6][9] + " |\n");
        System.out.print("    |---|---|---|---|---|---|---|---|---|---|\n");
        System.out.print("  8 | " + tacticalGrid[7][0] + " | " + tacticalGrid[7][1] + " | " + tacticalGrid[7][2] + " | " + tacticalGrid[7][3] + " | " + tacticalGrid[7][4] + " | " + tacticalGrid[7][5] + " | " + tacticalGrid[7][6] + " | " + tacticalGrid[7][7] + " | " + tacticalGrid[7][8] + " | " + tacticalGrid[7][9] + " |\n");
        System.out.print("    |---|---|---|---|---|---|---|---|---|---|\n");
        System.out.print("  9 | " + tacticalGrid[8][0] + " | " + tacticalGrid[8][1] + " | " + tacticalGrid[8][2] + " | " + tacticalGrid[8][3] + " | " + tacticalGrid[8][4] + " | " + tacticalGrid[8][5] + " | " + tacticalGrid[8][6] + " | " + tacticalGrid[8][7] + " | " + tacticalGrid[8][8] + " | " + tacticalGrid[8][9] + " |\n");
        System.out.print("    |---|---|---|---|---|---|---|---|---|---|\n");
        System.out.print(" 10 | " + tacticalGrid[9][0] + " | " + tacticalGrid[9][1] + " | " + tacticalGrid[9][2] + " | " + tacticalGrid[9][3] + " | " + tacticalGrid[9][4] + " | " + tacticalGrid[9][5] + " | " + tacticalGrid[9][6] + " | " + tacticalGrid[9][7] + " | " + tacticalGrid[9][8] + " | " + tacticalGrid[9][9] + " |\n");
        System.out.print("    |---|---|---|---|---|---|---|---|---|---|\n");
